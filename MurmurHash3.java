...
public class MurmurHash3 {
   ...
   public long MurmurHash(byte[] payload, final int seed){
      return MurmurHash3_x64_64(payload, seed);
   }
   
   public static void main(String[] args) {
	   MurmurHash3 mmh3 = new MurmurHash3();
	   System.out.println(mmh3.hash("hello".getBytes()));
	   System.out.println(mmh3.hash("2".getBytes()) % 1000000);
	   mmh3 = new MurmurHash3();
	   System.out.println(mmh3.hash("2".getBytes()) % 1000000);
   }
 }
